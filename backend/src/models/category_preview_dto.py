...
class CategoryPreviewDTO(Model):
    """
    Represents a single category preview in a list of category previews to be serialized
    to JSON.
...
class CategoryPreviewListDTO(Model):
    ...
    /categories allCategories (List[CategoryPreviewDTO]): A list containing all
