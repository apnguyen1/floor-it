...
from backend.src.models.brand_icon_dto import BrandDTO, BrandIconsDTO
from backend.src.scripts.brand_icons import BrandIcons
...
def mock_brand_icons_data():
    return BrandIconsDTO(
        questions=[
            BrandDTO(
                name="Champion",
                partial="https://raw.githubusercontent.com/fuzzysb/Logo-Quiz-Logos/"
                "master/Logos/Champion.png",
                full="https://raw.githubusercontent.com/fuzzysb/Logo-Quiz-Logos/master/"
                "Answers/Champion.png",
                answers=["Champion", "Champyon", "Champion Sport", "Champion Clothing"],
            ),
            BrandDTO(
                name="Sony",
                partial="https://raw.githubusercontent.com/fuzzysb/Logo-Quiz-Logos"
                "/master/Logos/Sony.png",
                full="https://raw.githubusercontent.com/fuzzysb/Logo-Quiz-Logos/master"
                "/Answers/Sony.png",
                answers=[
                    "Sony",
...
def test_brand_json(mock_load, mock_brand_icons_data):
    ...
    expected_output = {
        "https://raw.githubusercontent.com/fuzzysb/Logo-Quiz-Logos/master/Logos/"
        "Champion.png": [
            "Champion",
            "Champyon",
            "Champion Sport",
