...
from src.models.category_data_dto import QuestionType, TriviaQuestionDTO
from src.utils.category_mapper import to_category_data
...
def test_to_category_data_invalid_input(invalid_json):
    ...
    with pytest.raises(ValueError):
        to_category_data(category_name, question_type, invalid_json)
...
def test_to_category_data_valid_inputs(valid_json, expected_questions):
    ...
    model = to_category_data(category_name, question_type, valid_json)
